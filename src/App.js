...
export class App extends Component {
    ...
    render() {
        return `
            ...
            `
            <div class= 'd-flex justify-content-center position-absolute' style = "
            z-index: 5;
            ...
            <my-button  = 'eventtype' class="btn btn-outline-primary" type="button" id="button-addon2">save</my-button>
            </div>
            <ul class="list-group">
